...
var SpamFilter = {
    ...
    updateCounts: function(cat, tokens, callback) {
        ...
        Step(
            ...
            function(err, result) {
                ...
                for (i in tokens) { // Not sure I love this
                    filter.updateTokenCount(cat, tokens[i], catTotal, oppTotal, group());
                }
            },
    ...
    updateTokenCount: function(cat, token, catTotal, oppTotal, callback) {
